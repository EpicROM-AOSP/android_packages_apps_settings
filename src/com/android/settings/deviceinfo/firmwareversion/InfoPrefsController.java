...
import com.epic.utils.SpecUtils;
...
public class InfoPrefsController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        final LayoutPreference epicInfoPreference = screen.findPreference(KEY_EPIC_INFO);
        final TextView chipText = (TextView) epicInfoPreference.findViewById(R.id.chipset_summary);
        final TextView storText = (TextView) epicInfoPreference.findViewById(R.id.cust_storage_summary);
        final TextView battText = (TextView) epicInfoPreference.findViewById(R.id.cust_battery_summary);
        final TextView dispText = (TextView) epicInfoPreference.findViewById(R.id.cust_display_summary);
