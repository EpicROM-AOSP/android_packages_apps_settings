...
public class PowerUsageSummary extends PowerUsageBase implements
        ...
        if (BatteryHeaderPreferenceController.KEY_BATTERY_HEADER.equals(preference.getKey())) {
            ...
            if (batteryTemp) {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.epic.EpicUtils.batteryTemperature(getContext(), false));
                batteryTemp = false;
            } else {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.epic.EpicUtils.batteryTemperature(getContext(), true));
                batteryTemp = true;
            }
        }
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        restartBatteryInfoLoader();
        mBatteryTemp.setSubtitle(
                com.android.internal.util.epic.EpicUtils.batteryTemperature(getContext(), batteryTemp));
