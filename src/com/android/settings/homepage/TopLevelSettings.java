...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener, View.OnClickListener, PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
	...
	private MaterialCardView mDumpsterCard;
    ...
    mDumpsterCard = mDashboardHeader.findViewById(R.id.dashboard_dumpster);
    mAboutCard.setOnClickListener(this);
    mDisplayCard.setOnClickListener(this);
    mDumpsterCard.setOnClickListener(this);
        }
        ...
        for (int i = 0; i < count; i++) {
 	    ...
 	    String key = preference.getKey();
            ...
            if (key.equals("top_level_connected_devices")){
                preference.setLayoutResource(R.layout.epic_homepage_card_bot);
            }
            ...
            if (key.equals("top_level_wallpaper")){
                preference.setLayoutResource(R.layout.epic_homepage_card_sin);
            }
            if (key.equals("top_level_battery")){
                preference.setLayoutResource(R.layout.epic_homepage_card_battery);
            }
            if (key.equals("top_level_storage")){
                preference.setLayoutResource(R.layout.epic_homepage_card_storage);
			}
